...
const cat = {
    ...
    age: 13,
    showCat: function () {
       document.querySelector('#objectOutput').innerHTML = `Name: ${this.name} gehört zur Rasse ${this.breed}. <br>
...
function show(value) {
    document.querySelector('#output').innerHTML +=
        ...
        Alter: ${value.age}<br>
        Geboren im Jahr: ${value.birth.getFullYear()}<br>
        Geburtsmonat: ${month[value.birth.getMonth()]}<br>
...
function showAllCats(){
    document.querySelector('#output').innerHTML = "";
    allCats.sort((minAge, maxAge) => minAge.age - maxAge);
    showAge(allCats);
